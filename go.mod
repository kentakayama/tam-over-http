...
replace (
	github.com/veraison/eat => github.com/kentakayama/eat v0.0.0-20251208021338-394c5224e232
	github.com/veraison/go-cose => github.com/kentakayama/go-cose v0.0.0-20251212125603-77084a2d687b
)
